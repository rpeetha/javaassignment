package com.cryptograph.assignment.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.cryptograph.assignment.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.cryptograph.assignment.model" });
